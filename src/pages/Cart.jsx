      ...
      <div className="cart">
        ...
        <div className="content__items">
          ...
          <div className="cart__item">
            <div className="cart__item-img"><img className="pizza-block__image"
                                                 ...
                                                 alt="Pizza"/></div>
            <div className="cart__item-info"><h3>Пепперони</h3><p>тонкое, 26 см.</p></div>
            <div className="cart__item-count">
            ...
            <div className="cart__item-price"><b>1350 ₽</b></div>
            <div className="cart__item-remove">
              <div className="button button--outline button--circle">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="cart__item">
            <div className="cart__item-img"><img className="pizza-block__image"
                                                 ...
                                                 alt="Pizza"/></div>
            <div className="cart__item-info"><h3>Овощи и грибы 🌱</h3><p>тонкое, 26 см.</p></div>
            <div className="cart__item-count">
              <button disabled="" className="button button--outline button--circle cart__item-count-minus">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="cart__item-price"><b>285 ₽</b></div>
            <div className="cart__item-remove">
              <div className="button button--outline button--circle">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="cart__item">
            <div className="cart__item-img"><img className="pizza-block__image"
                                                 ...
                                                 alt="Pizza"/></div>
            <div className="cart__item-info"><h3>Сырная</h3><p>тонкое, 26 см.</p></div>
            <div className="cart__item-count">
              <button className="button button--outline button--circle cart__item-count-minus">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="cart__item-price"><b>1225 ₽</b></div>
            <div className="cart__item-remove">
              <div className="button button--outline button--circle">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="cart__item">
            <div className="cart__item-img"><img className="pizza-block__image"
                                                 ...
                                                 alt="Pizza"/></div>
            <div className="cart__item-info"><h3>Пепперони Фреш с перцем</h3><p>тонкое, 26 см.</p></div>
            <div className="cart__item-count">
              <button disabled="" className="button button--outline button--circle cart__item-count-minus">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="cart__item-price"><b>803 ₽</b></div>
            <div className="cart__item-remove">
              <div className="button button--outline button--circle">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <div className="cart__item">
            <div className="cart__item-img"><img className="pizza-block__image"
                                                 ...
                                                 alt="Pizza"/></div>
            <div className="cart__item-info"><h3>Цыпленок барбекю</h3><p>тонкое, 26 см.</p></div>
            <div className="cart__item-count">
              <button disabled="" className="button button--outline button--circle cart__item-count-minus">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="cart__item-price"><b>295 ₽</b></div>
            <div className="cart__item-remove">
              <div className="button button--outline button--circle">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span> Всего пицц: <b>12 шт.</b> </span><span> Сумма заказа: <b>4768 ₽</b> </span>
          </div>
